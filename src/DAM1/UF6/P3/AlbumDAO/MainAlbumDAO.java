package DAM1.UF6.P3.AlbumDAO;

import java.sql.Connection;
import java.sql.SQLException;
import java.util.Scanner;

public class MainAlbumDAO {
    public void menu() {
    ...
    public static void main(String args[]) throws SQLException {
        ...
        MainAlbumDAO mainAlbumDAO = new MainAlbumDAO();
        ...
        while (opcio != 0) {
            switch (opcio) {
                ...
                default: {
                    System.out.println("Introdueix un nombre vàlid del 0 al 5");
                    break;
                }
            }
